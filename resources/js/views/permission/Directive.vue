<template>
  <div class="app-container">
    ...
    <div :key="key" style="margin-top:30px;">
      ...
      <div>
        <span v-role="['teacher']" class="permission-alert">
          Only
          <el-tag class="permission-tag" size="small">teacher</el-tag> can see this
        </span>
        <el-tag v-role="['teacher']" class="permission-sourceCode" type="info">
          v-role="['teacher']"
        </el-tag>
      </div>
      <div>
      ...
      <div>
        <span v-role="['students']" class="permission-alert">
          Only
          <el-tag class="permission-tag" size="small">students</el-tag> can see this
        </span>
        <el-tag v-role="['students']" class="permission-sourceCode" type="info">
          v-role="['students']"
        </el-tag>
      </div>
    ...
    <div :key="'checkPermission'+key" style="margin-top:60px;">
      ...
      <el-tabs type="border-card" style="width:550px;">
        ...
        <el-tab-pane v-if="checkRole(['teacher'])" label="Manager">
          Manager can see this
          <el-tag class="permission-sourceCode" type="info">
            v-if="checkRole(['teacher'])"
          </el-tag>
        </el-tab-pane>
        ...
        <el-tab-pane v-if="checkRole(['students'])" label="Visitor">
          Visitor can see this
          <el-tag class="permission-sourceCode" type="info">
            v-if="checkRole(['students'])"
          </el-tag>
        </el-tab-pane>
