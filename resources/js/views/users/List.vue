    ...
    <el-table v-loading="loading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="Actions" width="350">
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.roles.includes('students')" v-permission="['manage user']" type="danger" size="small" icon="el-icon-delete" @click="handleDelete(scope.row.id, scope.row.name);">
            Delete
          </el-button>
        </template>
      </el-table-column>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      nonAdminRoles: ['editor', 'user', 'students'],
      newUser: {},
