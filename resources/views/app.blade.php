...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <link rel="icon" href="images/favicon.ico" type="{{ asset('depan/image/x-icon')}}">
    ...
    <link rel="stylesheet" href="{{ asset('depan/css/fonts.css')}}">
                ...
                <div class="rd-navbar-main">
                  ...
                  <div class="rd-navbar-nav-wrap">
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="">Clients</a>
                      </li>
                    </ul>
                  </div>
                </div>
