...
class SetupRolePermissions extends Migration
{
    ...
    public function up()
    {
        ...
        $studentsRole = Role::findByName(Acl::ROLE_STUDENTS);
        ...
        $teacherRole->givePermissionTo(Acl::permissions([Acl::PERMISSION_PERMISSION_MANAGE]));
